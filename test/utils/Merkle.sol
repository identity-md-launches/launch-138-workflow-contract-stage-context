...
/// @dev Minimal sorted-pair Merkle tree for tests. Matches OpenZeppelin `MerkleProof` (commutative
/// pair hash) and the promotion rule of scripts/merkle.py: an unpaired node moves up unchanged.
library Merkle {
